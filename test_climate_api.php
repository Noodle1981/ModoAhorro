...
echo "🧪 Test de API Climática\n\n";

$invoice = Invoice::with('equipmentUsages.equipment.category', 'equipmentUsages.equipment.type', 'contract.entity.locality')->find(1);

echo "Factura #1: {$invoice->start_date} - {$invoice->end_date}\n";
