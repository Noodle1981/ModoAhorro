<div class="min-h-screen bg-linear-to-br from-amber-50 via-white to-orange-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        
        {{-- Header --}}
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                <div class="bg-linear-to-br from-amber-400 to-orange-500 w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-lg">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="available_area" class="block text-sm font-medium text-gray-700 mb-1">
                                    Superficie Disponible ({{ $entity->square_meters > 0 ? round(($availableArea / $entity->square_meters) * 100) : 0 }}% del total)
                                </label>
                                
                                <div class="flex items-center gap-4 mb-2">
                                    <input 
                                        type="range" 
                                        wire:model.live="availableArea" 
                                        min="1" 
                                        max="{{ $entity->square_meters }}" 
                            ...
                            <div class="pt-2">
                                <span class="text-[10px] text-gray-400 uppercase tracking-widest font-bold flex items-center gap-2">
                ...
                @if(isset($result))
                    <div class="space-y-6" wire:loading.class="opacity-50 transition-opacity">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm text-center">
                                <p class="text-3xl font-bold text-emerald-500">{{ number_format($result['coverage_winter'] ?? 0, 0) }}%</p>
                                <p class="text-xs text-gray-500 uppercase font-medium">Cobertura Invierno</p>
                            </div>
                            <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm text-center">
                                <p class="text-3xl font-bold text-emerald-600">{{ number_format($result['coverage_summer'] ?? 0, 0) }}%</p>
