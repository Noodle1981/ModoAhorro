...
### 4. **BALLENAS / ELEFANTES** (Alta Incertidumbre)
...
$reqWhales   = sum(WHALES->kwh_estimated)
...
#### 3.4 - Ballenas (Distribución Ponderada)
```php
...
- **Comportamiento:** BASE y ANTS protegidos, WHALES recortados
...
**Solución:** El **remaining** tras BASE/ANTS es alto (350+ kWh). Se distribuye a WHALES proporcionalmente según pesos. Aires reciben x3 más que PCs.

### Caso B: Consumo Estimado > Facturado (Usuario sobreestimó)
**Ejemplo:** Estimado 257 kWh, Facturado 83 kWh

**Solución:** El **remaining** se agota en BASE CRÍTICA (recorte). HEAVY/ANTS/WHALES reciben 0.
...
|---------|------------------------------|---------------------------|
| Categorías | 4 (CRITICAL/HEAVY/ANTS/WHALES) | 3 (BASE/HORMIGAS/ELEFANTES) |
...
1. **Asume que el error está en WHALES:** Si un usuario sobreestimó luces (ANTS) pero subestimó heladera (CRITICAL), el ajuste no es óptimo.
