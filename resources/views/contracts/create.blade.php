        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm">Registra un contrato de suministro eléctrico</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('contracts.store') }}">
                ...
                <div class="mb-8 pb-8 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <x-input 
                            ...
                            type="number"
                            placeholder="0.00"
                            :value="old('contracted_power_kw_p1')"
                            helper="Pico"
                        />
                        <x-input 
                            ...
                            type="number"
                            placeholder="0.00"
                            :value="old('contracted_power_kw_p2')"
                            helper="Valle"
                        />
                        <x-input 
                            ...
                            type="number"
                            placeholder="0.00"
                            :value="old('contracted_power_kw_p3')"
                            helper="Resto"
                        />
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                    ...
                    <x-button variant="primary" type="submit">
                        <i class="bi bi-check-lg mr-2"></i> Guardar Contrato
                    </x-button>
                </div>
            </form>
        </x-card>
