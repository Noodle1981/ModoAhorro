...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {{-- Form --}}
        <x-card>
            <form method="POST" action="{{ route($config['route_prefix'] . '.invoices.update', [$entity->id, $invoice->id]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8 pb-8 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <x-input 
                            ...
                            label="Fecha Inicio" 
                            type="date"
                            :value="old('start_date', $invoice->start_date)"
                            required
                        />
                        <x-input 
                            name="end_date" 
                            label="Fecha Fin" 
                            type="date"
                            :value="old('end_date', $invoice->end_date)"
                            required
                        />
                    </div>
                </div>
                ...
                <div class="mb-8 pb-8 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                        <x-input 
                            ...
                            type="number"
                            placeholder="0"
                            :value="old('energy_consumed_p1_kwh', $invoice->energy_consumed_p1_kwh)"
                            helper="Pico"
                        />
                        <x-input 
                            ...
                            type="number"
                            placeholder="0"
                            :value="old('energy_consumed_p2_kwh', $invoice->energy_consumed_p2_kwh)"
                            helper="Valle"
                        />
                        <x-input 
                            ...
                            type="number"
                            placeholder="0"
                            :value="old('energy_consumed_p3_kwh', $invoice->energy_consumed_p3_kwh)"
                            helper="Resto"
                        />
                    </div>
                    ...
                    <div class="bg-emerald-50 rounded-xl p-4">
                        <x-input 
                            ...
                            type="number"
                            placeholder="0"
                            :value="old('total_energy_consumed_kwh', $invoice->total_energy_consumed_kwh)"
                            required
                            class="bg-white"
                        />
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        <x-input 
                            ...
                            type="number"
                            placeholder="0.00"
                            :value="old('cost_for_energy', $invoice->cost_for_energy)"
                        />
                        <x-input 
                            name="cost_for_power" 
                            ...
                            type="number"
                            placeholder="0.00"
                            :value="old('cost_for_power', $invoice->cost_for_power)"
                        />
                        <x-input 
                            name="taxes" 
                            label="Impuestos" 
