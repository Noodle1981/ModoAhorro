<div class="min-h-screen bg-linear-to-br from-orange-50 via-white to-amber-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        
        {{-- Header --}}
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                <div class="bg-linear-to-br from-orange-500 to-red-500 w-14 h-14 rounded-2xl flex items-center justify-center text-white shadow-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {{-- Input Form (if results not shown yet) --}}
            @if(!$result)
                    ...
                    <x-card>
                        <div class="text-center mb-6">
                            ...
                            <p class="text-gray-500 max-w-lg mx-auto">
                                No detectamos un termotanque eléctrico en tus equipos. Para calcular tu ahorro solar, estimaremos basándonos en la cantidad de personas.
                            </p>
                        </div>
                        ...
                        <div class="max-w-md mx-auto">
                            <div class="space-y-4">
                                <div class="bg-blue-50 p-4 rounded-lg flex items-start gap-3 text-sm text-blue-800">
                                    ...
                                    <p>El sistema calculará el ahorro para {{ $peopleCount }} personas en la zona de {{ $entity->locality->name ?? 'tu ubicación' }}.</p>
                                </div>

                                <x-button wire:click="calculate" variant="primary" class="w-full justify-center">
            ...
            @else
                    {{-- Recommendation --}}
                    <x-card class="border-2 border-emerald-200" wire:loading.class="opacity-50">
                        ...
                        <div class="px-4 py-4 bg-gray-50 rounded-xl mb-4">
                            ...
                            <p class="text-[10px] text-gray-400 text-center mt-1">Deslizá para ajustar el consumo</p>
                        </div>
