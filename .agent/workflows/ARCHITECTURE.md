# ---
# description: Arquitectura principal del motor energético de ModoAhorro.
# tags: [arquitectura, motor, energía, stack, servicios]
...
- Si detectas cambios en el stack tecnológico, notifica y sincroniza con notebook_sync.md.
...
Este documento describe la arquitectura y los componentes principales del sistema ModoAhorro. Consulta las secciones técnicas para detalles de implementación y flujos de negocio.
